    ...
    <el-card shadow="hover" class="search-panel" :class="{ 'is-collapsed': !showSearch }">
      ...
      <el-form ref="queryFormRef" :model="queryParams" :inline="true" class="query-form">
        ...
        <el-form-item label="能力 ID" prop="capabilityId">
          <el-input-number v-model="queryParams.capabilityId" controls-position="right"/>
        </el-form-item>
...
<script setup name="CapabilityTaskSearchPanel" lang="ts">
import {ElForm} from 'element-plus';
import {CapabilityTaskQuery} from '@/api/ai/capabilityTask/types';
...
const queryParams = ref<CapabilityTaskQuery>({
  pageNum: 1,
  pageSize: 10,
  taskId: undefined,
